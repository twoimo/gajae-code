...
export const WORKFLOW_MANIFEST: Record<CanonicalGjcWorkflowSkill, SkillManifest> = {
	...
	ralplan: manifest({
		...
		transitions: [
			...
			{ from: "critic", to: "deliberation", verb: "write-artifact" },
			{ from: "critic", to: "revision", verb: "write-artifact" },
			{ from: "deliberation", to: "revision", verb: "write-artifact" },
			{ from: "deliberation", to: "post-interview", verb: "write-artifact" },
			...
			{ from: "deliberation", to: "handoff", verb: "handoff" },
		...
		typedArgs: [
			...
			{ name: "irc", type: "boolean", appliesToVerbs: ["kickoff"] },
