...
function securityError(_pathname: string, result: NativeSecurity): ManagedSessionSecurityError {
	return managedSessionSecurityErrorForCode(result.ok ? undefined : result.code);
}
