	...
	return (
		<div className="dialog-backdrop" role="presentation" onMouseDown={onClose}>
			...
			>
				...
				<p>
					Use the palette to navigate GUI surfaces, run supported actions, or insert slash commands that are still
					prompt-only.
				</p>
				<ul>
					<li>
						<strong>/model</strong>, <strong>/theme</strong>, <strong>/session</strong>, <strong>/tools</strong>,{" "}
						<strong>/skills</strong>, <strong>/extensions</strong>, and <strong>/plugins</strong> open local
						panels.
					</li>
					<li>
						<strong>/compact</strong>, <strong>/retry</strong>, <strong>/new</strong>, <strong>/copy</strong>,{" "}
						<strong>/dump</strong>, <strong>/drop</strong>, and <strong>/resume</strong> run GUI actions.
					</li>
	...
	return (
		<div className="dialog-backdrop" role="presentation" onMouseDown={onClose}>
			<section
				...
				role="dialog"
				aria-modal="true"
				aria-labelledby="hotkeys-sheet-title"
				onMouseDown={event => event.stopPropagation()}
			>
				<header>
					<p className="eyebrow">Local reference</p>
